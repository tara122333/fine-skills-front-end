...
// import WorkShopPoster from "../components/Workshops/poster.workshop";
import WorkShopsCarouselPoster from "../components/WorkshopsCarousel/workshopCarousel.poster";
import Learn from '../Image/learning.svg';
import intract from '../Image/intract.svg';
    ...
    return(
        <>
            <div className="flex gap-7 flex-col">
                <div className="flex flex-col md:flex-row-reverse md:justify-between md:items-center md:my-7 ">
                    <div className="w-full h-96">
                        <div className="w-full h-full">
                            <img src={img} alt="hometheme" className="w-full h-full" />
                        </div>                   
                    </div>
                    <div className="flex flex-col gap-4 my-5 md:my-7">
                        {/* bottom */}
                ...
                <div className="flex gap-4 flex-col justify-center items-center md:my-7">
                ...
                <div className="flex flex-col my-5 md:flex-row justify-center items-center">
                    ...
                    <div className="flex flex-col my-4 gap-5">
                        ...
                        <div className="flex gap-3 ml-5 justify-center items-center">
                            <div className="flex justify-center items-center w-40 h-24 rounded-md p-1 bg-tara-0">
                ...
                <div>
                    <div className="flex flex-col mt-4 w-full gap-4">
                            ...
                            <div className="bg-tara-0 w-full flex flex-col gap-3">
                                <div className="grid grid-cols-2 text-white grid-rows-1 md:grid-cols-4 lg:grid-cols-5">
                                    <div className="w-full h-32 px-3 py-2">
                ...
                <div className="flex flex-col justify-center items-center">
                    ...
                    <div>
                        <h3>Poster Or Card</h3>
                    </div>
                    <div className="py-3 cursor-pointer" >
                        <button className="px-10 py-2 bg-tara-0 text-tara-1 rounded-full font-bold text-lg cursor-pointer">Explore More</button>
                    </div>
                </div>
            </div>
        </>
