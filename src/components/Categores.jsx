  ...
  return (
    <div className='flip-card'>
      <div className='flip-card-inner'>
        <div className='flex flex-col justify-center items-start border-2 border-tara-orange px-3 py-12 mx-3 gap-1 rounded-lg flip-card-front'>
        ...
        <div class="flip-card-back rounded-lg flex justify-center items-center flex-col gap-6">
